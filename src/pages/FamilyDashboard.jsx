...
const FamilyDashboard = () => {
  ...
  const handleSearchDetails = () => {
    const person = {
      name: formData.fullName || "Not Found",
      age: "N/A",
      approxAge: formData.approximateAge || "N/A",
      lastSeen: formData.lastSeenLocation || "N/A",
      dateRegistered: formData.dateLastSeen || "N/A",
      caseId: "NO MATCH",
      ...
      {foundPerson && (
        <div className="max-w-7xl mx-auto mt-8 p-6 bg-white rounded-xl shadow-md flex flex-col md:flex-row gap-6">
          <div className="flex-1 flex items-center justify-center">
            {foundPerson.photo ? (
              <img src={foundPerson.photo} alt={foundPerson.name} className="w-48 h-48 object-cover rounded-lg" />
            ) : (
